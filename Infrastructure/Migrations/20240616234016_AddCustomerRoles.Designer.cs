...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240616234016_AddCustomerRoles")]
    partial class AddCustomerRoles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Customers.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8d3e1ac5-7933-4cfe-af04-4066c3bbb3c6"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("5a161a3a-bdd1-4bb2-964d-ce0eab94490d"),
                            Name = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("CustomerRole", b =>
                {
                    b.HasOne("Domain.Customers.Customer", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_customer_role_customers_customers_id");

                    b.HasOne("Domain.Customers.Role", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_customer_role_roles_roles_id");
                });
